...
class UnidadeAdministrativaAdmin(admin.ModelAdmin): pass
class CampusAdmin(admin.ModelAdmin): pass
class CentroAdmin(admin.ModelAdmin): pass
class GrandeAreaAdmin(admin.ModelAdmin): pass
class AreaTematicaAdmin(admin.ModelAdmin): pass
class LinhaExtensaoAdmin(admin.ModelAdmin): pass
...
class Servidor_CursoExtensaoAdmin(admin.ModelAdmin): pass
class TurnoCursoAdmin(admin.ModelAdmin): pass
