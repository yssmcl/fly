...
PrevisaoOrcamentaria_CursoExtensaoFormSet = forms.models.inlineformset_factory(CursoExtensao, PrevisaoOrcamentaria_CursoExtensao, extra=0, min_num=0, max_num=1, form=PrevisaoOrcamentaria_CursoExtensaoForm)
