...
Nome completo: Foo \\%
(\ding{53}) Docente Efetivo %
(\phantom{\ding{53}}) Docente Temporário %
(\phantom{\ding{53}}) Agente Universitário \\%
...
\begin{mdframed}%
IDENTIFICAÇÃO: \\%
(\phantom{\ding{53}}) UNIOESTE \\%
(\phantom{\ding{53}}) PRAP \\%
(\phantom{\ding{53}}) SECRETARIA FINANCEIRA \\%
(\ding{53}) \textbf{FUNDAÇÃO}: %
fundacao%
\newline%
(\phantom{\ding{53}}) \textbf{OUTROS}: %
asd%
\newline%
\end{mdframed}%
\end{enumerate}%
